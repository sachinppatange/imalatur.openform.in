...
$allowedNext = ['dashboard.php', 'profile.php'];
...
<div class="wrap">
    <div class="card" role="region" aria-label="Login">
        <div class="topbar">
            <a class="top-link" href="signup.php<?php echo $next ? ('?next=' . urlencode($next)) : ''; ?>">Create New Account</a>
        </div>

        <h1>Login</h1>
        <div class="sub">Login with your phone number to continue</div>
